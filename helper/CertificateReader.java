...
public class CertificateReader {
	...
	public CertificateReader(String certificateFolderPath){
		this.certificateInfo = new ArrayList<String>();
	...
	public String getPublicKey1(){
		String key ="";
		if(certificateInfo.size()>= 0)
			key= certificateInfo.get(PUBLICKEY1).trim();
		return key;
	}
	...
	public String getPublicKey2(){
		String key ="";
		if(certificateInfo.size()>= 0)
			key= certificateInfo.get(PUBLICKEY2).trim();
		return key;
	}
}
